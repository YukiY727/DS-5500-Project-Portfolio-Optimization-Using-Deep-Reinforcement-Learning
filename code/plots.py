...
def plot_cpv(final_pf_values_opt, final_pf_values_eq, initial_portfolio_value, plot_name, save_path='test_result_plots/'):
...
def plot_wts_assigned(wt_vector, num_stocks, ticker_list, plot_name, save_path='test_result_plots/'):
